...
>
  ...
  applications who have access to webcam can make use of it, we have to check
...
**lower_angle_limit** and **upper_angle_limit** are the angle between the 3 points, two shoulders points and nose. **cv2.VideoCapture(0)** is used to capture the video throw the webcam
