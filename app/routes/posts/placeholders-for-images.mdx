...
meta:
  title: 'Placeholders for images'
  description: 'Placeholders occupy space for a future content, when loading larger images, 
...
We have a simple **div** with a class _img-container_ wrapping an **img** tag. Let's add some css
...
<ul>
  <li>
    <a href='https://web.dev/patterns/web-vitals-patterns/'>
