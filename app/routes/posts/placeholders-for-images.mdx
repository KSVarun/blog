...
**img** tag gives a handy event called **onload**, this event will be triggered when the image is loaded completely.
...
to avoid duplication this can be extracted to a separate function
